...
import static com.hpe.iot.mqtt.test.constants.TestConstants.SAMPLE_VERSION_MODIFIED;
...
public class MqttDCGroovyFileEventListenerTest {
	...
	private static final String SCRIPT_FILE_DIR = SRC_DIR + separator + TEST_DIR + separator + JAVA_DIR + separator
			+ "com" + separator + "hpe" + separator + "iot" + separator + "mqtt" + separator + "groovyscript"
	...
	@Test
	@DisplayName("test MQTT DC after on the fly script modification")
	public void testMQTTDCForModifiedGroovyScriptFile() throws IOException, URISyntaxException, InterruptedException {
