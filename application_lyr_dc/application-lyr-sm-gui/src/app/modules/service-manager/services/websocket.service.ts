...
export class WebsocketServerSocketFactoryService {
    ...
    private websocketBaseUrl = 'ws://' + window.location.hostname + ':8080' +
        '/' + this.baseHrefProviderService.getBaseHref() + 'dc';

    constructor(private baseHrefProviderService: BaseHrefProviderService, private socketFactory: WebSocketService) { }
