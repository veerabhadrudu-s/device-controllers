...
public class MMIClientToServerMessageGenerator implements ClientToServerMessageGenerator {
	...
	*/
	...
	private static final String[] IPCONNECT_DATA_MESSAGE_HEX =  [ "0c", "02", "01", "0c", "15", "17", "24",
			...
			"5f", "48", "20", "56", "31", "2e", "30", "2e", "33", "00" ] as String[];
	...
	*/
	...
	public static final String[] NOTIFICATION_MESSAGE_HEX = [ "00", "01", "04", "0c", "10", "11", "37",
			"13", "98", "26", "c9", "02", "d0", "2f", "ad", "10", "0d", "00", "01", "07", "67", "00", "00", "00", "00",
			"64", "00", "00", "00", "00", "00", "00", "00", "fc", "61", "74", "60" ] as String[];
	...
	*/
	...
	public static final String[] SOS_MESSAGE_HEX =  [ "06", "0c", "10", "09", "22", "1b", "4e", "ee", "c9", "02",
		 "3e", "8a", "ab", "10", "00", "00", "00","00", "03", "40", "00", "00", "00", "64", "00", "00", "00", 
		 "00", "00", "00", "00", "fb", "61", "0f", "a1"] as String[];
