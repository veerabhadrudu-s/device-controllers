 ...
 *
 */
public class TCPServerSocketReaderImpl implements TCPServerSocketReader {
	...
	public TCPServerSocketReaderImpl(ManagedExecutorService managedExecutorService,
	...
	protected void tryClosingSelector() {
		try {
